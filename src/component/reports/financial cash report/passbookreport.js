...
const Passbookreport = ({ Open, onClose }) => {
  Passbookreport.propTypes = {
  ...
  const handleLedger = (formDate, toDate) => {
    ...
    navigate('/passbookledger');
    setFormDate(formDate);
    sessionStorage.setItem('RPassbookformDate', formDate);
    setToDate(toDate);
    sessionStorage.setItem('RPassbooktoDate', toDate);
  };
