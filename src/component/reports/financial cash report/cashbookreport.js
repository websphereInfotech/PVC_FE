...
const Cashbookreport = ({ Open, onClose }) => {
  Cashbookreport.propTypes = {
  ...
  const handleLedger = (formDate, toDate) => {
    ...
    navigate('/cashbookledger');
    setFormDate(formDate);
    sessionStorage.setItem('RCashbookformDate', formDate);
    setToDate(toDate);
    sessionStorage.setItem('RCashbooktoDate', toDate);
  };
